defmodule TheScore.Players.Profile do
  ...
  def changeset(profile, attrs) do
    profile
    |> cast(attrs, [:name, :team, :position, :rushing_attempts_per_game_avg, :rushing_attempts, :total_rushing_yards, :rushing_average_yards_per_attempt, :rushing_yards_per_game, :total_rushing_touchdowns, :longest_rush, :rushing_first_downs, :rushing_first_down_percentage_1st, :rushing_yards_each_20_plus, :rushing_yards_each_40_plus, :rushing_fumbles])
    |> validate_required([:name, :team, :position, :rushing_attempts_per_game_avg, :rushing_attempts, :total_rushing_yards, :rushing_average_yards_per_attempt, :rushing_yards_per_game, :total_rushing_touchdowns, :longest_rush, :rushing_first_downs, :rushing_first_down_percentage_1st, :rushing_yards_each_20_plus, :rushing_yards_each_40_plus, :rushing_fumbles])
  end
end
